...
class ErrorController extends Saffron_AbstractController
{
	public function preDispatch()
    {
        ...
        $this->view->addBasePath(Zend_Controller_Front::getInstance()->getModuleDirectory($this->getRequest()->getModuleName()) . '/layouts/');
    ...
    {
        $this->view->render('headsection.phtml');
        $this->view->render('rightmenubar.phtml');
